...
namespace K2BlogApp.Data.Migrations
{
    ...
    [Migration("20230818134214_SeedCompleted")]
            ...
            modelBuilder.Entity("K2BlogApp.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8822db46-a7e1-4b9c-aa36-f47599a3401c"),
                            CategoryId = new Guid("b573250c-2835-4ac0-b126-110c65748ffb"),
                            Content = "LoremIpsum Dolor Sitamet Kontent Yazılsın",
                            CreatedBy = "Keno",
                            CreatedDate = new DateTime(2023, 8, 18, 16, 42, 14, 379, DateTimeKind.Local).AddTicks(9178),
            ...
            modelBuilder.Entity("K2BlogApp.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Keno",
                            CreatedDate = new DateTime(2023, 8, 18, 16, 42, 14, 379, DateTimeKind.Local).AddTicks(9413),
                            IsDeleted = false,
                            Name = "Genel"
                        });
                });
            ...
            modelBuilder.Entity("K2BlogApp.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Keno",
                            CreatedDate = new DateTime(2023, 8, 18, 16, 42, 14, 379, DateTimeKind.Local).AddTicks(9566),
